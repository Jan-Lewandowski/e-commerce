            ...
            <div className="grid gap-5 xl:grid-cols-[1fr_280px]">
              ...
              <div className="rounded-2xl border border-orange-100 bg-orange-50 p-5">
                ...
                <div className="mt-4 flex gap-3">
                  <select
                    className="h-11 rounded-xl border border-orange-200 bg-white px-3 text-sm font-semibold text-slate-900 outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100"
                    value={quantity}
                  ...
                  <Button className="flex-1" onClick={() => addToCart(product, quantity)}>Dodaj do koszyka</Button>
                </div>
                <div className="mt-3 text-sm text-slate-600">{`Pozostało ${product.stock} szt.`}</div>
              </div>
            </div>
